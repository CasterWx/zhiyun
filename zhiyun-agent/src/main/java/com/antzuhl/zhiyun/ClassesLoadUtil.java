...
public class ClassesLoadUtil {
    ...
    private static final Map<String, byte[]> path2Classes = new ConcurrentHashMap<String, byte[]>();
    private static final Map<String, byte[]> className2Classes = new ConcurrentHashMap<String, byte[]>();
